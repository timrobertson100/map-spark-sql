...
public class MapConfiguration {
  ...
  /** E.g. pass in the filename relative to the classpath, e.g. "/example.yml" */
  static MapConfiguration build(String filename) throws IOException {
    return new ObjectMapper(new YAMLFactory())
        .readValue(MapConfiguration.class.getResourceAsStream(filename), MapConfiguration.class);
  }
}
